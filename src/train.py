...
def main():
    ...
    parser.add_argument('--visualize', action='store_true', help='Render the emulator during training (use with --n-envs 1)')
    ...
    # SB3's stock EvalCallback already logs eval/mean_reward + eval/mean_ep_length, saves the best
    # model and triggers the early-stop via callback_on_new_best — no subclass needed.
